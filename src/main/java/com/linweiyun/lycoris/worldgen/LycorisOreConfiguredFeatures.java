...
public class LycorisOreConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        // 6：50左右
        register(context, NATURAL_BLUE_CRYSTAL_ORE_KEY, Feature.ORE, new OreConfiguration(stoneReplaceable,
                OreBlock.NATURAL_BLUE_CRYSTAL_ORE.get().defaultBlockState(),6));
        register(context, NATURAL_GREEN_CRYSTAL_ORE_KEY, Feature.ORE, new OreConfiguration(stoneReplaceable,
                OreBlock.NATURAL_GREEN_CRYSTAL_ORE.get().defaultBlockState(),6));
        register(context, NATURAL_YELLOW_CRYSTAL_ORE_KEY, Feature.ORE, new OreConfiguration(stoneReplaceable,
                OreBlock.NATURAL_YELLOW_CRYSTAL_ORE.get().defaultBlockState(),6));
