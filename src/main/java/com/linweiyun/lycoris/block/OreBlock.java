...
public class OreBlock  {
    ...
    public static final RegistryObject<Block> DEEPSLATE_NATURAL_RED_CRYSTAL_ORE = LycorisRegistry.registerBlock(
            "deepslate_natural_red_crystal_ore",
            BLOCKS, ()-> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops()
                    .strength(10f),
                    UniformInt.of(1,7)));

    public static final RegistryObject<Block> DEEPSLATE_NATURAL_BLUE_CRYSTAL_ORE = LycorisRegistry.registerBlock(
            "deepslate_natural_blue_crystal_ore",
            BLOCKS, ()-> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops()
                    .strength(10f),
                    UniformInt.of(1,7)));

    public static final RegistryObject<Block> DEEPSLATE_NATURAL_GREEN_CRYSTAL_ORE = LycorisRegistry.registerBlock(
            "deepslate_natural_green_crystal_ore",
            BLOCKS, ()-> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops()
                    .strength(10f),
                    UniformInt.of(1,7)));

    public static final RegistryObject<Block> DEEPSLATE_NATURAL_YELLOW_CRYSTAL_ORE = LycorisRegistry.registerBlock(
            "deepslate_natural_yellow_crystal_ore",
            BLOCKS, ()-> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops()
                    .strength(10f),
                    UniformInt.of(1,7)));
